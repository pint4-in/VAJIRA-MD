...
global.owner = process.env.OWNER_NUMBER  || '233241139503' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=rFEHQCYJ#UuyvERTtynue0-idsrIqQSbvb-p8L57Mb3XsfX_Mj_E' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'MR ROD' ,
...
ANTI_DELETE : process.env.ANTI_DELETE || ture ,
